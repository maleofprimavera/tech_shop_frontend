...
class RouteGenerator {
  static List<GetPage> routes = [
    GetPage(name: ScreenSplash.tag, page: () => const ScreenSplash()),
    ...
    GetPage(
        name: ScreenSearchProduct.tag, page: () => const ScreenSearchProduct()),

    ///Product Search

    GetPage(name: ScreenSignIn.tag, page: () => const ScreenSignIn()),

    ///Login

    GetPage(name: ScreenSignUp.tag, page: () => const ScreenSignUp()),

    ///Register

    GetPage(name: ScreenAccount.tag, page: () => const ScreenAccount()),

    ///User Account

    GetPage(name: ScreenProfile.tag, page: () => const ScreenProfile()),

    ///User Profile

    GetPage(name: ScreenContactUs.tag, page: () => const ScreenContactUs()),

    ///Contact us

    GetPage(name: ScreenWishlist.tag, page: () => const ScreenWishlist()),
    ...
    GetPage(
        name: ScreenProductDetail.tag,
        page: () => const ScreenProductDetail()),

    ///Product detail

    GetPage(
        name: ScreenOrderSummary.tag,
        page: () => const ScreenOrderSummary()),
    ...
    GetPage(name: ScreenOrderList.tag, page: () => const ScreenOrderList()),
